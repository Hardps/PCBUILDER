...
if(isset($_POST["submit"])){
  ...
  $duplicate = mysqli_query($conn, "SELECT * FROM psu WHERE (brand = '$brand' AND model = '$model' AND wattage = '$wattage')");
  if(mysqli_num_rows($duplicate) > 0){
    echo
    "<script> alert('product already added'); </script>";
  }
  else{
      $query = "INSERT INTO psu VALUES('','$brand', '$model','$wattage','$certification')";
  ...
  <body  style="margin: 0% ; background-image:url('imgs/pcback.jpg') ">
      <header>
        ...
        <div class="bg">
            ...
            <br>
              <div>
                <a class="backtext"><b>add psu</b></a>
              </div>
            <br>
            <br>
            <div>
        ...
        <div >
            ...
            <br>
            <div class="input-box">
                <label class="input-label" style="color:white">wattage</label><br>
                <input type="text" id="wattage" name="wattage" class="input-1" onfocus="setFocus(true)" onblur="setFocus(false)" id="wattage" required value=""/>
            </div>
            <br>
            <div class="input-box">
                <label class="input-label" style="color:white">certification</label><br>
                <input type="text" id="certification" name="certification" class="input-1" onfocus="setFocus(true)" onblur="setFocus(false)" id="certification" required value=""/>
            </div>
            <br>
