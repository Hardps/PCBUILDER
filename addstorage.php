...
if(isset($_POST["submit"])){
  ...
  $duplicate = mysqli_query($conn, "SELECT * FROM storage WHERE (model = '$model' AND types = '$types' AND capacity = '$capacity')");
  if(mysqli_num_rows($duplicate) > 0){
    echo
    "<script> alert('product already added'); </script>";
  }
  else{
      $query = "INSERT INTO storage VALUES('','$brand', '$model','$types','$capacity')";
  ...
  <body  style="margin: 0% ; background-image:url('imgs/pcback.jpg') ">
      <header>
        ...
        <div class="bg">
            ...
            <br>
              <div>
                <a class="backtext"><b>add storage</b></a>
              </div>
            <br>
            <br>
            <div>
        ...
        <div >
            ...
            <br>
            <div class="input-box">
                <label class="input-label" style="color:white">type</label><br>
